export default {
    ...
    billing: {
        insufficientBalance: {
            ...
            description: "Your balance is not enough to complete this generation. Please recharge and try again.",
            recharge: "Recharge",
        },
    },
