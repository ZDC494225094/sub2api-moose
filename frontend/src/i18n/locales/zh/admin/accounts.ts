export default {
    accounts: {
      ...
      viewModeLabel: '账号展示方式',
      viewModeList: '列表',
      viewModeUpstream: '按上游分组',
      dragSort: '拖动排序',
      dragSortDone: '完成排序',
      dragSortHint: '拖动手柄调整当前页顺序',
      dragHandle: '拖动调整顺序',
      dragHandleFor: '调整账号 {name} 的顺序，上下方向键也可移动',
      moveUp: '上移',
      moveDown: '下移',
      moveAccountUp: '上移账号 {name}',
      moveAccountDown: '下移账号 {name}',
      reorderSuccess: '账号顺序已更新',
      reorderFailed: '账号排序保存失败，已恢复原顺序',
      crossUpstreamDragBlocked: '聚合模式下只能在同一上游内排序',
      officialUpstream: '{platform} 官方上游',
      expandUpstreamGroup: '展开上游分组 {name}',
      collapseUpstreamGroup: '折叠上游分组 {name}',
      upstreamPageCount: '本页 {count} 个账号',
      upstreamPageSummary: '{platforms} · 正常 {active} · 异常 {errors} · 总并发 {concurrency}',
      upstreamGroup: '上游分组',
      upstreamGroupPlaceholder: '选择已有分组或输入新分组，例如 hi-code',
      upstreamGroupOption: '已有 {count} 个账号',
      upstreamGroupHint: '同名账号会聚合到一组，各账号可以使用不同的 Base URL。',
      upstreamGroupsLoading: '正在加载已有上游分组...',
      loadUpstreamGroupsFailed: '已有上游分组加载失败，可继续输入新分组',
      renameUpstreamGroup: '重命名分组',
      renameUpstreamGroupTitle: '重命名上游分组',
      renameUpstreamGroupPlaceholder: '输入新的上游分组名称',
      renameUpstreamGroupSuccess: '上游分组已重命名',
      renameUpstreamGroupFailed: '上游分组重命名失败',
      moveUpstreamGroupUp: '上移上游分组',
      moveUpstreamGroupDown: '下移上游分组',
      reorderUpstreamGroupsSuccess: '上游分组顺序已更新',
      reorderUpstreamGroupsFailed: '上游分组排序保存失败，已恢复原顺序',
      ungroupedUpstream: '未分组',
      ...
      upstreamBilling: {
        ...
        intervalMinutes: '自动检测频率',
        intervalHint: '范围 1-1440 分钟。',
        intervalInvalid: '自动检测频率必须是 1 至 1440 之间的整数',
        minutesUnit: '分钟',
        autoSyncRateMultiplier: '自动同步至账号计费倍率',
        autoSyncRateMultiplierHint: '探测成功后，将当前上游声明倍率写入账号计费倍率。',
        autoProbe: '自动探测上游声明倍率',
        autoProbeHint: '启用后按本账号设置的频率查询上游声明倍率；全局探测关闭时不会执行。',
        syncRate: '同步上游声明倍率',
      ...
      bulkSetUpstreamGroup: {
        title: '批量设置上游分组',
        selectionInfo: '将把上游分组应用到 {count} 个已选账号。',
        clear: '清空上游分组',
        clearHint: '移除所选账号当前的上游分组。',
        clearNotice: '保存后，所选账号将不再归入任何上游分组。',
        submit: '应用分组',
        submitting: '设置中...',
        required: '请选择或输入上游分组，或勾选清空分组。'
      },
      ...
      gitee: {
        accountTypeDesc: '使用 Gitee AI API Key 接入 OpenAI 兼容接口',
        baseUrlHint: 'Gitee AI OpenAI 兼容接口，默认使用 https://ai.gitee.com/v1',
        apiKeyHint: '在模力方舟工作台创建的 Gitee AI API Key',
        providerDesc: '此账号通过 Gitee AI 的 OpenAI 兼容接口调用模型。'
      },
