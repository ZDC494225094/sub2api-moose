export default {
    settings: {
      ...
      upstreamBillingProbe: {
        ...
        intervalHint: '范围 1–1440 分钟。成功探测结果的有效期为两个探测周期。',
        saved: '上游倍率自动探测设置已保存',
      ...
      site: {
        ...
        contactInfoHint: '填写客服联系方式，将展示在悬浮客服入口、兑换页面、个人资料等位置',
        afterSalesGroup: '售后群号',
        afterSalesGroupPlaceholder: '例如：QQ群 123456789',
        afterSalesGroupHint: '填写后将与客服联系方式一起展示在首页和控制台的悬浮客服入口',
        customerServiceLink: '一键联系链接',
        customerServiceLinkPlaceholder: '例如：https://work.weixin.qq.com/kfid/xxx',
        customerServiceLinkHint: '支持 http(s) 链接，填写后悬浮客服面板会显示“立即联系”按钮',
        docUrl: '文档链接',
