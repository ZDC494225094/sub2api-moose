export default {
  ...
  playground: {
    ...
    chatInput: '文本输入',
    imageInput: '生图输入',
    chatInputHint: '使用 Chat Completions 兼容接口，以流式对话形式调用模型。',
    imageInputHint: '使用 Images Generations 接口发起图片生成请求。',
    videoInputHint: '以流式对话生成视频脚本、分镜、镜头提示词和制作方案。',
    audioInputHint: '以流式对话生成音频脚本、配音提示词、音乐方向和制作方案。',
    systemPrompt: '系统提示词',
