export default {
    settings: {
      ...
      upstreamBillingProbe: {
        ...
        intervalHint: 'Range: 1–1440 minutes. A successful result remains valid for two detection intervals.',
      ...
      site: {
        ...
        contactInfoHint: 'Customer support contact info, displayed in the support widget, redeem page, profile, etc.',
        afterSalesGroup: 'After-sales Group',
        afterSalesGroupPlaceholder: 'e.g., QQ group 123456789',
        afterSalesGroupHint: 'Displayed with customer support details in the floating widget on the homepage and dashboard.',
        customerServiceLink: 'One-click Contact Link',
        customerServiceLinkPlaceholder: 'e.g., https://support.example.com/contact',
        customerServiceLinkHint: 'Accepts http(s) URLs and adds a Contact Now button to the floating support panel.',
