export default {
    accounts: {
      ...
      viewModeList: 'List',
      viewModeUpstream: 'Group by upstream',
      dragSort: 'Reorder',
      dragSortDone: 'Finish reordering',
      dragSortHint: 'Drag a handle to reorder this page',
      dragHandle: 'Drag to reorder',
      dragHandleFor: 'Reorder account {name}; the up and down arrow keys also move it',
      moveUp: 'Move up',
      moveDown: 'Move down',
      moveAccountUp: 'Move account {name} up',
      moveAccountDown: 'Move account {name} down',
      reorderSuccess: 'Account order updated',
      reorderFailed: 'Could not save account order; the previous order was restored',
      crossUpstreamDragBlocked: 'Accounts can only be reordered within the same upstream group',
      officialUpstream: '{platform} official upstream',
      expandUpstreamGroup: 'Expand upstream group {name}',
      collapseUpstreamGroup: 'Collapse upstream group {name}',
      upstreamPageCount: '{count} accounts on this page',
      upstreamPageSummary: '{platforms} · {active} active · {errors} errors · {concurrency} total concurrency',
      upstreamGroup: 'Upstream group',
      upstreamGroupPlaceholder: 'Choose an existing group or enter a new one, e.g. hi-code',
      upstreamGroupOption: '{count} existing accounts',
      upstreamGroupHint: 'Accounts with the same name are grouped together and may use different Base URLs.',
      upstreamGroupsLoading: 'Loading existing upstream groups...',
      loadUpstreamGroupsFailed: 'Could not load existing upstream groups; you can still enter a new group',
      renameUpstreamGroup: 'Rename group',
      renameUpstreamGroupTitle: 'Rename upstream group',
      renameUpstreamGroupPlaceholder: 'Enter a new upstream group name',
      renameUpstreamGroupSuccess: 'Upstream group renamed',
      renameUpstreamGroupFailed: 'Could not rename upstream group',
      moveUpstreamGroupUp: 'Move upstream group up',
      moveUpstreamGroupDown: 'Move upstream group down',
      reorderUpstreamGroupsSuccess: 'Upstream group order updated',
      reorderUpstreamGroupsFailed: 'Could not save upstream group order; the previous order was restored',
      ungroupedUpstream: 'Ungrouped',
      ...
      upstreamBilling: {
        ...
        intervalMinutes: 'Auto-detection interval',
        intervalHint: 'Range: 1-1440 minutes.',
        intervalInvalid: 'The auto-detection interval must be an integer between 1 and 1440',
        minutesUnit: 'min',
        autoSyncRateMultiplier: 'Auto-sync to billing rate multiplier',
        autoSyncRateMultiplierHint: 'After a successful detection, write the current upstream declared rate to the account billing rate multiplier.',
        autoProbe: 'Automatically probe upstream declared rate',
        autoProbeHint: 'Probe this account\'s upstream declared rate at its configured interval when global probing is enabled.',
      ...
      bulkActions: {
        ...
        refreshToken: 'Refresh Token',
        setUpstreamGroup: 'Set upstream group',
      ...
      bulkSetUpstreamGroup: {
        title: 'Set Upstream Group',
        selectionInfo: 'Apply an upstream group to {count} selected account(s).',
        clear: 'Clear upstream group',
        clearHint: 'Remove the current upstream group from selected accounts.',
        clearNotice: 'After saving, selected accounts will no longer belong to an upstream group.',
        submit: 'Apply group',
        submitting: 'Applying...',
        required: 'Choose or enter an upstream group, or select clear group.'
      },
