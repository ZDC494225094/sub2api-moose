    ...
    >
      ...
      <div v-if="form.type === 'apikey' && form.platform !== 'antigravity'" class="space-y-4">
        ...
        >
          ...
          <div
            v-if="upstreamBillingAutoProbeEnabled && form.platform === 'openai' && !isGiteeAI"
      ...
      <!-- OpenAI API 长上下文计费开关 -->
      <div
        v-if="form.platform === 'openai' && !isGiteeAI && !hideAccountLongContextBilling && (accountCategory === 'oauth-based' || accountCategory === 'apikey')"
        class="border-t border-gray-200 pt-4 dark:border-dark-600"
      >
        <div class="flex items-center justify-between gap-4">
          <div>
