...
const planForm = reactive({ name: '', group_id: null as number | null, description: '', price: 0, original_price: 0, display_purchase_count: 0, currency: '', validity_days: 30, validity_unit: 'days', sort_order: 0, for_sale: true })
