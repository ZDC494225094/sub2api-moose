...
func init() {
	...
	apikeyDescPlatform := apikeyFields[4].Descriptor()
	// apikey.DefaultPlatform holds the default value on creation for the platform field.
	apikey.DefaultPlatform = apikeyDescPlatform.Default.(string)
	...
	apikeyDescBillingPriority := apikeyFields[6].Descriptor()
	...
	// groupDescBillingRateSyncAccountID is the schema descriptor for billing_rate_sync_account_id field.
	groupDescBillingRateSyncAccountID := groupFields[3].Descriptor()
	// group.BillingRateSyncAccountIDValidator is a validator for the "billing_rate_sync_account_id" field. It is called by the builders before save.
	group.BillingRateSyncAccountIDValidator = groupDescBillingRateSyncAccountID.Validators[0].(func(int64) error)
	// groupDescBillingRateMarkup is the schema descriptor for billing_rate_markup field.
	groupDescBillingRateMarkup := groupFields[4].Descriptor()
	// group.DefaultBillingRateMarkup holds the default value on creation for the billing_rate_markup field.
	group.DefaultBillingRateMarkup = groupDescBillingRateMarkup.Default.(float64)
	// group.BillingRateMarkupValidator is a validator for the "billing_rate_markup" field. It is called by the builders before save.
	group.BillingRateMarkupValidator = groupDescBillingRateMarkup.Validators[0].(func(float64) error)
	...
	// subscriptionplanDescDisplayPurchaseCount is the schema descriptor for display_purchase_count field.
	subscriptionplanDescDisplayPurchaseCount := subscriptionplanFields[5].Descriptor()
	// subscriptionplan.DefaultDisplayPurchaseCount holds the default value on creation for the display_purchase_count field.
	subscriptionplan.DefaultDisplayPurchaseCount = subscriptionplanDescDisplayPurchaseCount.Default.(int)
