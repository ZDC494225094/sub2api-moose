...
func RegisterAuthRoutes(
	...
	{
		auth.POST("/registration-proof/challenge", rateLimiter.LimitWithOptions("auth-registration-proof", 30, time.Minute, middleware.RateLimitOptions{
			FailureMode: middleware.RateLimitFailClose,
		}), h.Auth.CreateRegistrationProofChallenge)
