...
// enhanceCSPPolicy ensures nonce, media preview, captcha, and payment SDK requirements.
// This keeps runtime components working when an older config has not added the new directives yet.
