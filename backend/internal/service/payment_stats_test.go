	...
	require.Equal(t, []DailyStats{
		{
			...
			BalanceAmount: CurrencyAmounts{}, SubscriptionAmount: CurrencyAmounts{"CNY": 15.56},
			SubscriptionCount: 2, NewUserCount: 2, NewUserAmount: CurrencyAmounts{"CNY": 15.56},
			ReturningUserAmount: CurrencyAmounts{},
		},
		{
			Date: "2026-07-25", Amount: CurrencyAmounts{"USD": 30}, Count: 2,
			BalanceAmount: CurrencyAmounts{}, SubscriptionAmount: CurrencyAmounts{"USD": 30},
			SubscriptionCount: 2, ReturningUserCount: 2, ReturningUserAmount: CurrencyAmounts{"USD": 30},
			NewUserAmount: CurrencyAmounts{},
		},
	}, daily)
