...
func TestAPIKeyService_RejectsV15AuthSnapshotWithoutMultiGroupBillingRouting(t *testing.T) {
	groupID := int64(9)
	svc := &APIKeyService{}
	...
	if ok {
		t.Fatalf("expected v15 auth snapshot to be rejected after multi-group billing routing was added")
	}
	if apiKey != nil {
